...
const sampleFirstNameValue = 'Bob';
const sampleLastNameValue = 'Jones';
const sampleValidEmailValue = 'bobjones@bogusemail.com';
const sampleInvalidEmailValue = 'bobjones';
const samplePhoneNumberValue = '111-111-1111';
const sampleDescriptionValue = 'I have winter coats to donate.';
...
class FormHTMLTags {
  ...
  constructor(private testFixture: ComponentFixture<DonationFormComponent>) {
